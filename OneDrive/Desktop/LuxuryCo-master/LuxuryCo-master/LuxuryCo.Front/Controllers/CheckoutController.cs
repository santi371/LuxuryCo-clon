...
public class CheckoutController : Controller
{
    ...
    private readonly string _apiCheckoutUrl = (Environment.GetEnvironmentVariable("API_BASE_URL") ?? "http://localhost:5137") + "/api/checkout/process";
    private readonly string _apiCartUrl = (Environment.GetEnvironmentVariable("API_BASE_URL") ?? "http://localhost:5137") + "/api/carrito";
