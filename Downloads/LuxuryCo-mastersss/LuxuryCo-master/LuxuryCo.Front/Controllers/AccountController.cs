    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            ...
            try
            {
                ...
                var response = await client.PostAsync("http://localhost:5040/api/auth/login", requestBody);
            ...
            {
                ModelState.AddModelError(string.Empty, "Error de conexión con el Backend: Asegúrate de que tu proyecto 'LuxuryCo.Back' se esté ejecutando al mismo tiempo en el puerto 5037. Detalles:" + ex.Message);
            }
            return View(model);
        }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            try
            {
                ...
                var response = await client.PostAsync("http://localhost:5040/api/auth/register", content);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            ...
            var response = await client.PostAsync("http://localhost:5040/api/auth/forgot-password", content);
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordViewModel model)
        {
            ...
            var response = await client.PostAsync("http://localhost:5040/api/auth/reset-password", content);
