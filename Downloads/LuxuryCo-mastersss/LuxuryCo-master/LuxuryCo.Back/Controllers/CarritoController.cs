...
public class CarritoController : ControllerBase
{
    ...
    public async Task<IActionResult> AddToCart([FromBody] AddToCartRequest request)
    {
        ...
        try 
        {
            var success = await _carritoService.AddToCartAsync(idUsuario, request.IdProducto, request.Cantidad, request.Talla, request.Color);
    ...
    public async Task<IActionResult> UpdateQuantity(int id, [FromBody] UpdateQuantityRequest request)
    {
        ...
        try 
        {
            var success = await _carritoService.UpdateQuantityAsync(idUsuario, id, request.Cantidad, request.Talla, request.Color);
