...
public class ProductoService : IProductoService
{
    ...
    public async Task<ProductoDto> GetByIdAsync(int id)
    {
        ...
        // Obtener variantes desde el inventario
        var variantes = await _context.InventariosSede
            .Include(i => i.Talla)
            .Include(i => i.Color)
            .Where(i => i.id_producto == id)
            .Select(i => new VarianteDto
            {
                IdTalla = i.id_talla,
                TallaNombre = i.Talla != null ? i.Talla.nombre_talla : null,
                IdColor = i.id_color,
                ColorNombre = i.Color != null ? i.Color.nombre_color : null,
                ColorHex = i.Color != null ? i.Color.codigo_hex : null,
